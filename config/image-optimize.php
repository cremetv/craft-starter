...
return [
    ...
    'imageProcessors'            => [
        ...
        'optipng'   => [
            ...
            'commandPath'           => '/usr/local/optipng/bin/optipng',
            'commandOptions'        => '-o3 -strip all',
            'commandOutputFileFlag' => '',
        ],
        'pngcrush'  => [
            // 'commandPath'           => '/usr/bin/pngcrush',
            'commandPath'           => '/usr/local/pngcrush/bin/pngcrush',
            'commandOptions'        => '-brute -ow',
            'commandOutputFileFlag' => '',
        ],
        'pngquant'  => [
            // 'commandPath'           => '/usr/bin/pngquant',
            'commandPath'           => '/usr/local/pngquant/bin/pngquant',
        ...
        'svgo'      => [
            ...
            'commandPath'           => '/usr/local/svgo/bin/svgo',
            'commandOptions'        => '',
            'commandOutputFileFlag' => '',
        ],
        // gif optimizers
        'gifsicle'  => [
            ...
            'commandPath'           => '/usr/local/gifsicle/bin/gifsicle',
    ...
    'imageVariantCreators' => [
        ...
        'cwebp' => [
            ...
            'commandPath'           => '/usr/local/webp/bin/cwebp',
            'commandOptions'        => '',
